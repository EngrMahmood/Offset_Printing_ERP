...
urlpatterns = [
    ...
    path('q/p/<int:job_card_id>/', views.qr_redirect_printing, name='qr_redirect_printing'),
    path('q/k/<int:job_card_id>/', views.qr_redirect_packing, name='qr_redirect_packing'),
    path('q/d/<int:job_card_id>/', views.qr_redirect_dispatch, name='qr_redirect_dispatch'),
    ...
    path('flexo/', include('flexo.urls', namespace='flexo')),
    ...
    path('settings/access-control/users/delete/', views.access_user_delete, name='access_user_delete'),
